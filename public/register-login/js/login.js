              ...
              firebase.auth().signInWithPhoneNumber(phoneNumber, appVerifier)
                  .then(function (confirmationResult) {
                    ...
                    $('#phone').html(`<span style="color: red" class="error"></span>
                      ...
                      <input type="hidden" id="phoneNumber" class="form-control input_user" value="`+phone+`" placeholder="code">`);
                    $('#verify').empty();
                    $('#logo').html('Login');
...
//                     $('#phone_form').html(`<input type="hidden" id="phoneNumber" value="`+phone+`">
