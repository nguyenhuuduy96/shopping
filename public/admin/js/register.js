...
$(document).ready(function () {
  ...
  $('#register').on('submit',function(event){
    ...
    if(RetypePass ==""){
      $('#error_RetypePass').css('display','block');
      $('#error_RetypePass').html('vui lòng nhập pass word!');
       return false;
    }else if(RetypePass!==pass){
      $('#error_RetypePass').css('display','block');
      $('#error_RetypePass').html('error_RetypePass nhap ko khop!');
       return false;
    }else{
      $('#error_RetypePass').css('display','none');
    }
     $.ajax({
        url:"save-register",
        method:"post",
