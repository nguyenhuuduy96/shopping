                ...
                <div class="item-slick1" style="background-image: url({{$item->image}});">
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                            ...
                            <a href="{{$item->url}}" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
                                    Shop Now
                                </a>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    ...
                    <a href="{{isset($setting->url_banner1)?$setting->url_banner1:"#"}}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    ...
                    <div class="block1 wrap-pic-w">
                        ...
                        <a href="{{isset($setting->url_banner2)?$setting->url_banner2:"#"}}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
                            <div class="block1-txt-child1 flex-col-l">
                                <span class="block1-name ltext-102 trans-04 p-b-8">
                                    Áo
                                </span>
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    ...
                    <div class="block1 wrap-pic-w">
                        ...
                        <a href="{{isset($setting->url_banner3)?$setting->url_banner3:"#"}}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
                            <div class="block1-txt-child1 flex-col-l">
                                <span class="block1-name ltext-102 trans-04 p-b-8">
                                    Phụ kiện
                                </span>
