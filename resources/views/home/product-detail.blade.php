							...
							<div class="slick3 gallery-lb">
								...
								<div class="item-slick3" data-thumb="{{asset($image->image)}}">
									<div class="wrap-pic-w pos-relative">
										...
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{asset($image->image)}}">
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="Color" id="color_p">
											...
											<option value="{{$color->color_id}} {{ $color->color}}">{{$color->color}}</option>
											@endforeach
										</select>
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="id_size_detail" id="id_size_detail">
											...
											<option value="{{$size->pivot->id}}">{{$size->size}} - ({{$size->pivot->stock}})</option>
											@endforeach --}}
										</select>
										<div class="dropDownSelect2"></div>
									</div>
