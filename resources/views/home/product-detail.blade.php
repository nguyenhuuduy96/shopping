                        ...
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                @foreach ($product->images as $image)
                                    <div class="item-slick3" data-thumb="{{ asset($image->image) }}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="{{ asset($image->image) }}" alt="IMG-PRODUCT">
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        <h4 class="mtext-105 cl2 js-name-detail p-b-14">
                            ...
                            <input type="hidden" name="product_detail_slug" id="product_detail_slug"
                                value="{{ $product->slug }}">
                            <input type="hidden" name="cartImage" id="cartImage"
                                value="{{ asset(isset($product->firstImage[0]->image) ? $product->firstImage[0]->image : 'img/default.jpg') }}">
                        </h4>
                        ...
                        <div class="p-t-33">
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                ...
                                <div class="size-204 respon6-next">
                                    <div class="rs1-select2 bor8 bg0">
                                        <select class="js-select2" name="Color" id="color_p">
                                            <option value="">Choose an option</option>
                                            @foreach ($colors as $color)
                                                <option value="{{ $color->color_id }} {{ $color->color }}">
                                                    {{ $color->color }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                ...
                                <div class="size-204 respon6-next">
                                    <div class="rs1-select2 bor8 bg0">
                                        <select class="js-select2" name="id_size_detail" id="id_size_detail">
                                            <option value="">Choose an option</option>
                                            {{-- @foreach ($product->sizes as $size)
                                                <option value="{{ $size->pivot->id }}">{{ $size->size }} -
                                                    ({{ $size->pivot->stock }})</option>
                                            @endforeach --}}
                                        </select>
                                        <div class="dropDownSelect2"></div>
                                    </div>
                                    ...
                                    <div class="p-b-30 m-lr-15-sm">
                                        ...
                                        <div class="flex-w flex-t p-b-68">
                                            <div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
                                                <img src="{{ asset('home/images/avatar-01.jpg') }}" alt="AVATAR">
                                            </div>
                        ...
                        <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                            ...
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img src="{{ asset(isset($product->firstImage[0]->image) ? $product->firstImage[0]->image : 'img/default.jpg') }}"
                                        alt="IMG-PRODUCT">

                                    {{-- <a href="#"
                                        class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1 Quick_View"
                                        id="{{ $product->id }}" >
                                        Quick View
                                    </a> --}}
                                </div>
                                ...
                                <div class="block2-txt flex-w flex-t p-t-14">
                                    <div class="block2-txt-child1 flex-col-l ">
                                        ...
                                        <span class="stext-105 cl3" id="home_price">
                                            {{ number_format(isset($product->firstprice[0]->price) ? $product->firstprice[0]->price : '0', 0, '.', '.') }}
                                            đ
